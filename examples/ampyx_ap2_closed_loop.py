...
N_sim = 350 # Closed-loop simulation steps
...
figname = './ampyx_ap2_closed_loop_isometric.png'
fig.savefig(figname)

from math import ceil
for v in [31.626, 70.083, 113.602, 228.233, 410.633, 600.006]:
    m = ceil(v/60)
    s = v % 60
    print('{:.0f}'.format(m)+'min '+'{:.0f}'.format(s)+'s.')
