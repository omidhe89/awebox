...
def aero():
    ...
    stab_derivs['CX'] = {}
    stab_derivs['CX']['0'] = [-0.072] #TH:[-0.0293]
    stab_derivs['CX']['alpha'] = [-0.425, 0.87] #TH:[0.4784, 2.5549]
    stab_derivs['CX']['q'] = [0.]*2 #TH:[-0.6029, 4.4124]
    # stab_derivs['CX']['alpha_q'] = [4.4124]
    stab_derivs['CX']['deltae'] = [0.]*2 #TH:[-0.0106, 0.1115]
    # stab_derivs['CX']['alpha_deltae'] = [0.1115]

    stab_derivs['CY'] = {}
    stab_derivs['CY']['beta'] = [0.]*3 #TH:[-0.1855, -0.0299, 0.0936]
    # stab_derivs['CY']['alpha_beta'] = [-0.0299]
    # stab_derivs['CY']['alpha2_beta'] = [0.0936]
    stab_derivs['CY']['p'] = [0.]*3 #TH:[-0.1022, -0.0140, 0.0496]
    # stab_derivs['CY']['alpha_p'] = [-0.0140]
    # stab_derivs['CY']['alpha2_p'] = [0.0496]
    stab_derivs['CY']['r'] = [0.]*2 #TH:[0.1694, 0.1368]
    # stab_derivs['CY']['alpha_r'] = [0.1368]
    stab_derivs['CY']['deltaa'] = [0.]*3 #TH:[-0.0514, -0.0024, 0.0579]
    # stab_derivs['CY']['alpha_deltaa'] = [-0.0024]
    # stab_derivs['CY']['alpha2_deltaa'] = [0.0579]
    stab_derivs['CY']['deltar'] = [0.]*3 #TH:[0.10325, 0.0268, -0.1036]
    # stab_derivs['CY']['alpha_deltar'] = [0.0268]
    # stab_derivs['CY']['alpha2_deltar'] = [-0.1036]

    stab_derivs['CZ'] = {}
    stab_derivs['CZ']['0'] = [-1.4] #TH:[-0.5526]
    stab_derivs['CZ']['alpha'] = [-5.73, 0.] #TH:[-5.0676, 5.7736]
    stab_derivs['CZ']['q'] = [0.]*3 #TH:[-7.5560, 0.1251, 6.1486]
    # stab_derivs['CZ']['alpha_q'] = [0.1251]
    # stab_derivs['CZ']['alpha2_q'] = [6.1486]
    stab_derivs['CZ']['deltae'] = [0.]*3 #TH:[-0.315, -0.0013, 0.2923]
