#!/usr/bin/python3
"""
Closed-loop MPC simulation of circular pumping trajectory of a single 3DOF kite system
using external forces computed according to the aerodynamic model of AWEbox.
...
figname = './3dof_external_aero_isometric.png'
fig.savefig(figname)
