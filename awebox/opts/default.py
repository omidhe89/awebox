...
#>>>>>>> develop
        ...
        ('nlp',  'cost',             None, 'power_der',            False,                    ('power derivative regularization for lift-mode reel-out phase', (True, False)),'t'),
        ('nlp',  'cost',             None, 'power_der_start',      0.1,                    ('start of power derivative regularization for lift-mode reel-out phase', None),'t'),
        ('nlp',  'cost',             None, 'power_der_stop',       0.9,                    ('stop of power derivative regularization for lift-mode reel-out phase', None),'t'),
        ...
        ('solver',  'initialization', None, 'shape',                'circular',  ('set initialization shaep ', ['circular', 'lemniscate']), 's'),
...
#<<<<<<< HEAD
        ('solver',   'weights',        None,   'yaw',                   1,          ('optimization weight for state variable yaw [-]', None),'s'),
