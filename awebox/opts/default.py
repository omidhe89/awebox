...
def set_default_options(default_user_options, help_options):
    ...
    default_options_tree = [
        ...
        ('params',  'model_bounds',  None,           'airspeed_limits',     np.array([13., 40.]),  ('airspeed limits [m/s]', None),'s'),
        ...
        ('ndi', None,  None,    'ctrl_params_actuator',  np.array([0.25, 0.25, 0.25]), (' actuators controller parameters', None), 'x'),
        ...
        ('visualization', 'cosmetics', 'trajectory', 'axisfont',    {'size': '15'}, ('???', None), 'x'),
        ...
        ('visualization', 'cosmetics', None,         'save_figs',   True,          ('save the figures', [True, False]), 'x'),
