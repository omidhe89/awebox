#!/usr/bin/python3
"""
MPC-based closed loop simulation example for a single 3DOF/6DOF kite system.
"""
...
closed_loop_sim.plot(['states'])
closed_loop_sim.plot(['isometric'])

# adapt isometric plot
fig = plt.gcf()
...
ax.legend([l[n], l[0]], ['ref', 'mpc'], fontsize=14)
plt.show()
